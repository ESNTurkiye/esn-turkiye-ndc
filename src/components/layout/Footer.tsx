                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
                    <div className="space-y-3 sm:space-y-4 md:space-y-4 lg:space-y-5">
                        ...
                        <p className="text-gray-700 text-xs sm:text-xs md:text-sm lg:text-base">
                            ...
                            We are a non-partisan, non-profit, international student
                            organisation. Our mission is to represent international students,
                            thus provide opportunities for cultural understanding and
                            self-development under the principle of
                            <span className="text-esn-dark-blue font-bold italic">
                                {" "}
                        ...
                        <div className="hidden">
                            <a
                                href="#"
                                className="text-gray-600 hover:text-esn-dark-blue underline decoration-gray-400 underline-offset-4 transition"
                            >
                                Privacy Policy
                            </a>
                        </div>
                    ...
                    <div className="space-y-3 sm:space-y-4 md:space-y-4 lg:space-y-5">
                        <div className="pt-2 sm:pt-2 md:pt-0">
                            <h4 className="text-gray-900 font-display uppercase tracking-wide mb-2 text-xs sm:text-xs md:text-sm lg:text-base">
                                Project Governance
                            </h4>
                    ...
                    <div className="space-y-3 sm:space-y-4 md:space-y-4 lg:space-y-5">
                        <div>
                            <h5 className="text-gray-900 font-display uppercase tracking-wide mb-2 sm:mb-3 text-xs sm:text-xs md:text-sm lg:text-base">
                                Follow Us
                            </h5>
                            <div className="flex flex-wrap gap-3 sm:gap-4">
                                ...
                                >
                                    <svg
                                        className="w-6 h-6 sm:w-6 md:w-7 lg:w-8"
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                        ...
                        <div className="pt-3 sm:pt-4 md:pt-4 border-t border-gray-300 space-y-2">
                            <p className="text-gray-600 text-xs sm:text-xs md:text-sm leading-relaxed">
                                We've taken extra care to reach high accessibility standards. If
                                you have any comment, please let us know.
                            </p>
                            <div>
                                ...
                                <p className="text-gray-600 text-[10px] sm:text-[10px] md:text-xs leading-relaxed">
                                    This website uses Google Analytics 4 to collect anonymous,
                                    aggregated usage statistics that help us understand how the
                                    Barriers of Mobility project is accessed and improve student
                                    mobility advocacy. No personally identifiable information is
                                    collected, and data is processed in line with ESN Türkiye&apos;s
                                    privacy commitments.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-3 md:gap-4 lg:gap-6 text-[10px] sm:text-[10px] md:text-xs lg:text-sm text-gray-600">
                    <div className="flex items-center gap-2 sm:gap-2 md:gap-3 lg:gap-4">
                        <span className="text-center md:text-left">
                            ...
                            <span className="bg-gray-300 px-2 py-1 text-gray-800">
