...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-linear-to-b from-esn-dark-blue/70 via-esn-dark-blue/50 to-esn-dark-blue/60 z-1" />

            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-esn-cyan/10 rounded-full blur-[100px] z-2" />
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-esn-light-blue/10 rounded-full blur-[120px] z-2" />
            ...
            <div
                ...
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === "Enter" && scrollToReport()}
                aria-label="Scroll down to report section"
            >
                <div className="flex flex-col items-center gap-2 text-white/80 hover:text-white transition-colors group">
