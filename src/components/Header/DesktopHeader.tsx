                ...
                <nav className="hidden md:block" aria-label="Main navigation">
                    <ul className={`flex items-center space-x-8 text-white font-body font-bold tracking-wider transition-all duration-300 ease-in-out ${
                        ...
                        <li className="relative group py-4">
                            ...
                            <div className="absolute top-full left-0 w-48 bg-white shadow-xl rounded-b-lg border-t-2 border-esn-cyan opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50" role="menu">
                                        ...
                                        >
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2 hover:bg-gray-50 hover:text-esn-cyan cursor-pointer transition-colors ${
                                                    index < navigationLinks.about.length - 1 ? 'border-b border-gray-100' : ''
                                                }`}
                                                aria-label={`Navigate to ${link.label} section`}
                                            >
                                                {link.label}
                        ...
                        <li className="py-4">
                            <button 
                                onClick={() => scrollToSection(navigationLinks.survey.sectionId)} 
                                className="bg-white text-esn-dark-blue px-6 py-2 rounded-full hover:bg-gray-100 transition shadow-md"
